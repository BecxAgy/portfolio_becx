  ...
  return <div className="h-full  bg-primary/30 py-32 text-center xl:text-left">
      ...
      ">
        <div className="flex-1  flex flex-col justify-center">
          <h2 className="h2">Capitivation <span className="text-accent"> stories</span> birth magnificant designs.</h2>
          
          <p className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
            2 Years ago, I began in Analysis and Development Systems in Instituto Federal da Bahia. 
            Now i work with web development</p>
        </div>
        {/* counters */}
        <div>
          <div>
        ...
        <div className=" flex flex-col w-full xl:max-w-[48%] h-[480px]">
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:max-0 mb-4">
            {aboutData.map((item, itemIndex)=> (
              <div key={itemIndex} className={`${index === itemIndex && 'text-accent after:bg-accent after:transition-all after:duration-300'} 
          ...
          <div className=" py-2 xl:py-6 flex flex-col gapy-y-4 items-center xl:items-start">
